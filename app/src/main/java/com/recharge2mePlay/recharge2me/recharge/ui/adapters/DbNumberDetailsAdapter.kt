...
import com.recharge2mePlay.recharge2me.recharge.ui.fragments.PrePaidFragmentDirections
import kotlinx.android.synthetic.main.db_number_card.view.*
import local_Databasse.entity_numberDetails

class DbNumberDetailsAdapter(activity: FragmentActivity) : RecyclerView.Adapter<DbNumberDetailsAdapter.myViewHolder>() {
    ...
    override fun onBindViewHolder(holder: myViewHolder, position: Int) {
        ...
        holder.itemView.db_card_numberDetails.setOnClickListener {
            val action = PrePaidFragmentDirections.actionPrePaid3ToMobileDetailsFinder("null", "null")
