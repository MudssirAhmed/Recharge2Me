...
public class Pay2AllRechargeFirebase {
    ...
    public Pay2AllRechargeFirebase() {
    }

    public Pay2AllRechargeFirebase(String status, String status_id, String orderid, String utr, String report_id, String message,
