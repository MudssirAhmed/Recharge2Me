...
public class TupFragment extends Fragment {
        ...
        call.enqueue(new Callback<PlanData>() {
            ...
            public void onResponse(Call<PlanData> call, Response<PlanData> response) {
                ...
                try {
                    ...
                    List<RecTypeTUP> tup = data.getTUP();
                    ...
                    rv_planTup.addOnItemTouchListener(new PlanAdapter.planRecyclerTouchListener((GetRechargePlanActivity) requireActivity(),
                        ...
                        public void onPlanClick(View view, int position, View btn) {
                            ...
                            RecTypeTUP sendTup = tup.get(position);
    ...
    private void setDataOnRecyclerView(List<RecTypeTUP> tup){

        try {
            PlanAdapter planAdapter_ = new
                    PlanAdapter(null, null, null, tup, null, (GetRechargePlanActivity) requireActivity());

            rv_planTup.setAdapter(planAdapter_);
            rv_planTup.setLayoutManager(new LinearLayoutManager((GetRechargePlanActivity) requireActivity()));
            activity.hideProgressBar();
        }
        catch (Exception e){
