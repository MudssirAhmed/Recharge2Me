...
public class Paytm_refundStatus {
    ...
    public Paytm_refundStatus() {
    }

    public Paytm_refundStatus(String orderID, String userCreditInitiateStatus, String resultStatus, String resultCode, String resultMsg,
