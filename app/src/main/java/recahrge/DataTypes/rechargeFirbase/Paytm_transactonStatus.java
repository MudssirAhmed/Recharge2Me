...
public class Paytm_transactonStatus {
    ...
    public Paytm_transactonStatus() {
    }

    public Paytm_transactonStatus(String resultStatus, String resultCode, String resultMsg, String txnId,
